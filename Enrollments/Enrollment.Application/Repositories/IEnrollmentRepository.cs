...
{
    Task AddEnrollment(Enrollment.Domain.Entities.Enrollment enrollment, CancellationToken ct = default);
    Task AddEnrollments(IEnumerable<Enrollment.Domain.Entities.Enrollment> enrollments, CancellationToken ct = default);
